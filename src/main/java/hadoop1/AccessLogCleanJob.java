...
//
///**
// * 清洗用户access日志信息 主要的驱动程序 主要用作组织mapper和reducer的运行
// *
// * 输入参数： hdfs://ns1/input/data-clean/access/2018/04/08
// * hdfs://ns1/output/data-clean/access 即inputPath和outputPath
// * 目前outputPath统一到hdfs://ns1/output/data-clean/access
// * 而inputPath则不确定，因为我们的日志采集是按天来生成一个目录的 所以上面的inputPath只是清洗2018-04-08这一天的
// */
