...
//
///**
// * access日志清洗的主要mapper实现类 原始数据结构： appid ip mid userid login_tpe request status
// * http_referer user_agent time ---> 10列内容 清洗之后的结果： appid ip province city mid
// * userid login_type request method request_url http_version status http_referer
// * user_agent browser yyyy-MM-dd HH:mm:ss
// */
...
//
//	private String status; // 请求的状态主要有：200 ok、/404 not found、408 Request Timeout、500 Internal Server
//							// Error、504 Gateway Timeout等
//	private String httpReferer; // 请求该url的上一个url地址。
//	private String userAgent; // 浏览器的信息，例如："Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML,
...
//
//	/**
//	 * appid ip mid userid login_tpe request status http_referer user_agent time
//	 * ---> 10列内容 || || appid ip province city mid userid login_type request method
//	 * request_url http_version status http_referer user_agent browser yyyy-MM-dd
//	 * HH:mm:ss
//	 */
//	@Override
...
//		}
//		AccessLogWritable access = new AccessLogWritable(appid, ip, province, city, mid, userId, loginType, request,
//				method, requestUrl, httpVersion, status, httpReferer, this.userAgent, browser, time);
