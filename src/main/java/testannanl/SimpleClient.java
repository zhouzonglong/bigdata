...
public class SimpleClient {
	...
	public static void main(String[] args) throws Exception {
		CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("192.168.83.129", 11111),
				"example", "", "");
	...
	private static void printColumns(List<Column> columns) {
		for (Column column2 : columns) {
			System.out.println(column2.getName() + "::" + column2.getValue());
		}
